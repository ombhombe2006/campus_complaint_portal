...
document.getElementById('loginForm').addEventListener('submit', async function(e) {
    ...
    try {
        const response = await fetch('http://localhost:8080/campus-review-portal/api/login', {
            method: 'POST',
            headers: {
...
async function loadRecentReviews() {
    try {
        const response = await fetch('http://localhost:8080/campus-review-portal/api/reviews/recent');
